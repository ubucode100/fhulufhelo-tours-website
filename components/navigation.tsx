              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`px-5 py-1 rounded-full transition-colors duration-200 text-sm
                    ${isActive(link.href) ? "bg-foreground text-white shadow" : "text-foreground hover:bg-gray-100"}`}
                >
                  {link.name}
                </Link>
              ))}
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`w-full text-center px-4 py-2 rounded-full transition-colors duration-200 text-lg
                    ${isActive(link.href) ? "bg-foreground text-white shadow" : "text-gray-700 hover:bg-gray-100"}`}
